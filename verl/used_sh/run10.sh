...
save_path=/cfs_turbo/alanhshao/copo/copo-code/outputs/0523/7b_instruct_grpo_onlyGlobal #"/workspace/datasets/CO2/r1-vl/3b_instruct_grpo_onlyGlobal_k5b1" # 存储权重文件的路径
