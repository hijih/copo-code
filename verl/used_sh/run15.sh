...
save_path=/cfs_turbo/alanhshao/copo/copo-code/outputs/0524/3b_instruct_grpo_soft0K10b1_2 #"/workspace/datasets/CO2/r1-vl/3b_instruct_grpo_onlyGlobal_k5b1" # 存储权重文件的路径
model_path=/home/tione/notebook/alanhshao/pretrained_models/Qwen2.5-3B-Instruct ###### 3B~ #####
wandb_name="verl_3b_instruct_grpo_soft0K10b1_2" # wandb实验名称
