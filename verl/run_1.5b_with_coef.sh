set -x
export RAY_TMPDIR=/workspace/datasets/ray_tmp
...
save_path="/workspace/datasets/CO2/r1-vl/1.5b_math_global_coef_0.1" # 存储权重文件的路径
model_path="/workspace/datasets/LVLMs/Qwen/Qwen2.5-1.5B-math-Instruct" # 初始模型路径（需下载）
wandb_name="verl_1.5b_math_global_coef_0.1" # wandb实验名称
...
global_flg="only-soft-with-coef"
global_loss_coef=0.1
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.global_loss_coef=${global_loss_coef} \
    ...
    trainer.total_training_stepts=71 \
