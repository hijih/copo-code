...
save_path="/workspace/datasets/CO2/r1-vl/7b_instruct_onlySoft0K5b1" # 存储权重文件的路径
model_path="/workspace/datasets/LVLMs/Qwen/Qwen2.5-7B-Instruct" # 初始模型路径（需下载）
wandb_name="verl_7b_instruct_onlySoft0K5b1" # wandb实验名称
