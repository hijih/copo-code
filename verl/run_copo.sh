...
##### train ####
train_path=$data_path/DAPO-Math-17k/data/dapo-math-17k.parquet
train_files="['$train_path']"
math500_test_path=$data_path/math500.parquet 
aime24_test_path=$data_path/aime24.parquet
test_files="['your_test_path']"
loss_agg_mode="seq-mean-token-mean"
global_flg="soft-with-zero"
soft_blending_k=5
soft_blending_b=1
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.k=${soft_blending_k} \
    actor_rollout_ref.actor.b=${soft_blending_b} \
