...
save_path="/workspace/datasets/CO2/r1-vl/3b_instruct_grpo_onlySoft" # 存储权重文件的路径
model_path="/workspace/datasets/LVLMs/Qwen/Qwen2.5-3B-Instruct" # 初始模型路径（需下载）
wandb_name="verl_3b_instruct_grpo_onlySoft_k5b1" # wandb实验名称
...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.actor.global_flg='only soft' \
