...
save_path=/home/tione/notebook/alanhshao/copo/copo-code/outputs/0523/3b_instruct_grpo_soft0K1b1 #"/workspace/datasets/CO2/r1-vl/3b_instruct_grpo_onlyGlobal_k5b1" # 存储权重文件的路径
...
wandb_name="verl_3b_instruct_grpo_soft0K1b1" # wandb实验名称
